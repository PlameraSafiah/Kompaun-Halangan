...
<form name=komp method="POST" action="hg158a.asp">
<%	rowid = request.querystring("rowid")
	...
	s = s & " to_char(tkh_bayar,'dd/mm/yyyy')tkh_bayar,no_kontena,butir_kesalahan"
	...
	if not gq.eof then
		...
		'JMilik = gq("jenis_pemilikan")
		'Jkenderaan = gq("jenis_kenderaan")
...
%>
<table width="85%" align="center" cellspacing=1 bgcolor="<%=color1%>" style="font-family: Trebuchet MS; font-size: 10pt;" cellpadding="0" border="0">
  <tr> 
    <td width="133" bgcolor="<%=color1%>"><font color="#FFFF00">No Kompaun</font></td>
    <td colspan="3" bgcolor="<%=color2%>"><%=kompaun%> </td>
    <td bgcolor="<%=color1%>"><font color="#FFFF00">No Akaun</font></td>
    <td bgcolor="<%=color2%>"><%=no_akaun%></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td bgcolor="lightgrey" colspan="3" > <%=kenderaan%></td>
    <td width="96" bgcolor="936975"><font  color="#FFFF00">No Cukai Jalan</font></td>
    <td width="118" bgcolor="#D3D3D3"><%=cukai%></td>
  </tr>
  <tr> 
 ...
 <!-- <tr> 
  ...
  <tr> 
    ...
    <td bgcolor="lightgrey" colspan="3" height="8"> <%=tkh_kompaun%> &nbsp; </td>
    <td width="96" bgcolor="936975" height="8"><font color="#FFFF00">Waktu</font></td>
    <td width="118" bgcolor="#D3D3D3" height="8"> <%=formatnumber(waktu,2)%> &nbsp;<%=ampm%>&nbsp;</td>
  </tr>
  <tr> 
    <td width="133" bgcolor="936975"><font color="#FFFF00">Tempat</font></td>
    <td colspan="3" bgcolor="lightgrey"><%=tempat%></td>
    <td width="96" bgcolor="936975"><font color="#FFFF00">Daerah</font></td>
    <td bgcolor="lightgrey" width="118"><%=daerah%></td>
  </tr>
  <!--<tr> 
