...
<% 
	...
	tkhdd = objRstt("tkhss")
		...
		d = d & " initcap(tempat1)tempat1,nvl(amaun,0)amaun,no_fail,butir_kesalahan, initcap (catitan) catitan , "
        ...
        tkhmm = sd("tkhmm")
	    tkhyy = sd("tkhyy")
		'butirsalah = sd("butir_kesalahan")
	    butirsalah = sd("catitan")
...
<p class="standard"></p>
  ...
  <table width=78% cellspacing="0" cellpadding="0" style="font-family: Times New Roman; font-size: 11pt;" align="center">
    ...
    <tr > 
      ...
      <td width=76% rowspan="2" valign="top">: <%=butirsalah%></td>
    </tr>
    <tr> 
      <td width=24%>&nbsp;</td>
    </tr>
