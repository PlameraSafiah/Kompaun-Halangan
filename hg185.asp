...
%>
  ...
  <table width="90%" cellspacing="1" align="center">
    <tr bgcolor="<%=color1%>" style="font-family: Trebuchet MS; font-size: 10pt; font-weight:bold; color:yellow;" align="center"> 
      <td width="29">Bil</td>
      <td width="45">Akta</td>
      <td width="261">Akta Kesalahan</td>
      <td width="86">Kod Kesalahan </td>
      <td width="368">Jenis Kesalahan </td>
      <td width="66">Rekod</td>
      <td width="66">Belum Bayar </td>
      <td width="66">Sudah Bayar </td>
      <td width="124">Amaun(RM)</td>
    </tr>
<%bil = 0
  belum = 0
  jamaun = 0
  ...
  Do while not rsx.eof
	 ...
	 y = "select keterangan from kompaun.akta where kod='"&akta&"' "
	 set rsy=objconn.execute(y)
	 if not rsy.eof then 
	 keterangan=rsy("keterangan")
	 end if
%>

    <tr bgcolor="<%=color2%>" style="font-family: Trebuchet MS; font-size: 10pt;  "> 
      <td align="center" width="29"><%=bil%></td>
      <td align="left" width="45"><%=akta%></td>
      <td align="left" width="261"><%=keterangan%></td>
      <td align="left" width="86"><%=kesalahan%></td>
      <td align="left" width="368"><%=ket%></td>
      <td align="center" width="66"><%=rekod%></td>
    ...
    <tr bgcolor="<%=color1%>"  style="font-family: Trebuchet MS; font-size: 10pt; font-weight:bold;  "> 
      ...
      <td align="center" width="66"><%=jrekod%></td>
      <td align="center" width="66"><%=jbelum%></td>
      <td align="center" width="66"> 
        <%if jsudah > 0 then%>
