...
<%	
	Set objConn = Server.CreateObject ("ADODB.Connection")
	 ...
	 nama = request.cookies("cookies")
		...
		b = b & " initcap(tempat)tempat,initcap(tempat1)tempat1,butir_kesalahan perkara, "
		b = b & " akta perkara1,to_char(sysdate,'dd/mm/yyyy') tkh,pengeluar_kompaun "
		...
		response.write"<p>&nbsp;</p>"
		response.write"<p><b>SALINAN KOMPAUN BERTARIKH : "&sb("tkh")&"</b></p>"
		response.write"<p></p>"
		response.write"<b>No.Akaun&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</b>"&sb("no_akaun")&"<br>"
		response.write"<b>No.Kompaun&nbsp;&nbsp;:&nbsp;&nbsp;</b>"&sb("no_kompaun")&"<br>"
		response.write"<b>Tarikh&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</b>"&sb("tkh1")&"<br>"
		response.write"<b>Tempat&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</b>"&sb("tempat")&"<br>"
		response.write"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"&sb("tempat1")&"<br>"
		response.write"<b>Kesalahan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b><br>"
		response.write""&sketer&"</p>"
		response.write""&sketer2&"</p>"
		response.write"<b>Pegawai Yang Mengeluarkan Kompaun :</b><br>"
		response.write""&nopengeluar&"-"&npengeluar&"<br>"
