 ...
 <tr> 
  ...
  <tr> 
     ...
     <td width="50%" bgcolor="<%=color2%>" style="color:black" colspan="5"> 
      ...
      <br>
      <input type="radio" value="KIV" name="tindakan" <%if tindakan="KIV" then%>checked<%end if%> >
      KIV&nbsp;
      <input type="text" name="tindakan1" size="40" value="<%=tindakan1%>" maxlength="60" onFocus="nextfield='B2';">
      <br>
  ...
  <tr>
      ...
      <input type="submit" value="Simpan" name="B2" onFocus="nextfield='done';" style="font-family: Trebuchet MS; font-size: 8pt; font-weight: bold"></td>
    </tr>   
