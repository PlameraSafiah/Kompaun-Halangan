...
<%	
	 ...
	 nama = request.cookies("cookies")
		...
		b = b & " initcap(tempat)tempat,initcap(tempat1)tempat1,butir_kesalahan perkara5, catitan ,  "
...
<table width="500">				
		...
		<tr>
		<td width="392"><b>Kesalahan :</b></td>
		</tr>
		<tr>
		<td><%=sketer%><%=sketer2%></td>
		</tr>       
		<tr>
		<td width="392"><b>Butir-Butir Kesalahan : </b></td>
		</tr> 
		<tr>
		<td width="392"><%=objkd1("catitan")%></td>
		</tr>	
		<tr>
