...
%> 
 ...
 '============================================== SUB CARI ====================================
	  sub cari
		d = " select a.rowid,a.no_kompaun,initcap(a.nama) nama,a.tkh_undang,a.no_akaun,a.tempat,a.tempat1,a.tkh_kompaun, "
		...
		d = d & " and to_date('"& tkh2 &"','dd/mm/yyyy') and a.no_kompaun = b.no_kompaun order by a.no_kompaun "
