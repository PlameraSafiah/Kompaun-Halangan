...
function invalid_kompaun1(b)
    {  
       alert (b+" Sila Masukkan No Akaun !!! ");
		return(true);
    }
...
<%	
	...
	rujuk = Request.QueryString("rujuk")
     ...
     if tkh2s > tkhs then
		...
		if not Rsh.eof then
           ...
           Set Rsr1 = objConn.Execute(r1)
			...
			s =     "insert into kompaun.halangan (no_kenderaan,nama,kp,alamat1,alamat2,alamat3,tkh_notis1) "
...
'***************************************	PROSES CARI	***************************************************
  ...
  if proses = "Cari" then
     ...
     if noakaun = ""  then
        mula
        response.write "<script language=""javascript"">"
        response.write "var timeID = setTimeout('invalid_kompaun1(""  "");',1) "
        response.write "</script>"
        response.end
	 ...
	 elseif kompaun = ""  then
        ...
        sk =      "select amaun_bayar,nvl(no_resit,'0') resit,mahkamah,no_resit from hasil.bil "
        sk = sk & " where no_akaun='"& noakaun &"' and no_rujukan = '"& kompaun &"' "
        ...
        if rssk.eof then
           ...
           resitx = rssk("resit")
		   mahkamahx = rssk("mahkamah")
		   no_resit = rssk("no_resit")
           if resitx = "BATAL" then
              mula
              response.write "<script language=""javascript"">"
              response.write "var timeID = setTimeout('invalid_batal(""  "");',1) "
              response.write "</script>"
              response.end
		   elseif no_resit <> "" then
		   		mula
              response.write "<script language=""javascript"">"
              response.write "var timeID = setTimeout('invalid_rekod1(""  "");',1) "
              response.write "</script>"
              response.end
		   elseif mahkamah <> "" then
		   		mula
              response.write "<script language=""javascript"">"
              response.write "var timeID = setTimeout('invalid_rekod2(""  "");',1) "
              response.write "</script>"
              response.end
           elseif resitx = "MAHKAMAH" then
              papar
           elseif resitx = "0" then
              papar
           else
			  papar
           end if
...
<table width="95%" align="center" cellspacing=0 bgcolor="<%=color1%>" style="font-family: Trebuchet MS; font-size: 10pt;" cellpadding="1">
        <tr> 
          <td width="127" bgcolor="<%=color1%>">&nbsp;<font color="#FFFF00">No 
          Akaun</font></td>
          <td bgcolor="#CCCCCC"> <input type="text" name="noakaun" maxlength="11" value="<%=noakaun%>" size="12" onFocus="enter('kereta','1');" > <font color="#FF0000">*</font>
            <b></b><font face="Arial" size="1">&nbsp; </font></td>
        </tr>
		 <tr> 
          <td width="127" bgcolor="<%=color1%>"><font color="#FFFF00">&nbsp;No 
           Kompaun</font></td>
          <td bgcolor="#CCCCCC"><input name="kompaun" type="text" value="<%=kompaun%>" size="12" maxlength="11" onFocus="enter('B1','1');"> <font color="#FF0000">*</font>
...
'**************************************************************************************************
  ...
  e = 	"select nama,kp,alamat1,alamat2,alamat3,no_kenderaan,masa,to_char(tkh_kompaun,'dd/mm/yyyy') tkompaun, "
  e = e & " to_char(tkh_notis1,'ddmmyyyy') tarikh_notis1 from kompaun.halangan "
  e = e & " where no_kompaun = '"& kompaun &"' and no_akaun = '"& noakaun &"' "
  ...
  z =     "select rowid,no_resit,to_char(tkh_bayar,'dd/mm/yyyy')tkh_bayar,to_char(tkh_masuk,'dd/mm/yyyy') tkompaun, "
  z = z & " masa,perkara5,to_char(tarikh_notis1,'ddmmyyyy') tarikh_notis1"
  z = z & "  from hasil.bil "
  z = z & " where no_rujukan = '"& kompaun &"' and perkara1='"& kereta &"' and perkara = 'P01' "
...
<table width="95%" align="center" cellspacing=0 bgcolor="<%=color1%>" style="font-family: Trebuchet MS; font-size: 10pt;" cellpadding="1">
      ...
      <tr> 
        <td width="127" bgcolor="<%=color1%>">&nbsp;<font color="#FFFF00">No 
          Kompaun</font></td>
        <td bgcolor="#CCCCCC"> 
          <input type="text" name="kompaun" maxlength="11" value="<%=kompaun%>" size="12" onFocus="enter('B1','1');" >
          &nbsp;<input type="hidden" name="noakaun" value="<%=noakaun%>" ></td>
      </tr>
      <tr> 
        <td bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;No 
          Kenderaan</font></td>
        <td bgcolor="#CCCCCC"> 
      ...
      <tr> 
        <td height="25" nowrap bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;Tarikh 
          Kompaun</font></td>
        <td bgcolor="#CCCCCC"><%=tkompaun%></td>
      </tr>
      <tr> 
        <td height="25" nowrap bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;Waktu 
          Kompaun </font></b></td>
        <td bgcolor="#CCCCCC"><%=masa%>&nbsp;<%=ampm%></td>
      </tr>
      <tr> 
        <td nowrap bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;Tarikh 
          Notis</font></td>
        <td bgcolor="#CCCCCC"> 
      ...
      <tr> 
        <td nowrap bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;No 
          Rujukan </font></td>
        <td bgcolor="#CCCCCC"> 
      ...
      <tr> 
        <td bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;Tarikh 
          Sebutan</font></td>
        <td bgcolor="#CCCCCC"> 
      ...
      <tr> 
        <td bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;No 
          Saman 1</font></td>
        <td bgcolor="#CCCCCC"> 
          <input type="text" name="no_saman" value="<%=no_saman%>" size="15" maxlength="10" onFocus="enter('no_saman2','2');">
          <b><font color="#FFFF00">&nbsp;</font></b> </td>
      </tr>
      <tr> 
        <td bgcolor="<%=color1%>" width="127"><font color="#FFFF00"> 
          &nbsp;No Saman 2</font></td>
        <td bgcolor="#CCCCCC"> 
          <input type="text" name="no_saman2" value="<%=no_saman2%>" size="15" maxlength="10" onFocus="enter('nama','2');">
        </td>
      </tr>
      <tr> 
        <td bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;Nama</font></td>
        <td bgcolor="#CCCCCC"> 
      ...
      <tr> 
        <td bgcolor="<%=color1%>" valign="top" width="127"><font color="#FFFF00">&nbsp;Alamat</font></td>
        <td bgcolor="#CCCCCC"> 
      ...
      <tr> 
        <td bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;Mahkamah</font></td>
  ...
  %>
      ...
      <tr> 
        <td bgcolor="<%=color1%>" width="127"><font color="#FFFF00">&nbsp;Keputusan 
          Kes</font></td>
        <td bgcolor="#CCCCCC"> 
          <input type="text" name="keputusan" value="<%=keputusan%>" size="105" maxlength="100" onFocus="enter('denda','2');">
        </td>
      </tr>
	  <tr> 
        
      <td bgcolor="<%=color1%>" ><font color="#FFFF00">&nbsp;Bayaran 
        Denda Mahkamah</font></td>
        <td bgcolor="#CCCCCC"> 
          <input type="text" name="denda" value="<%=amaun_denda%>" size="20" maxlength="100" onFocus="enter('b1save','2');">
        </td>
      </tr>
      <tr> 
